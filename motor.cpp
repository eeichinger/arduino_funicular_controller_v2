...
static void myISR() {
  ...
  byte newRotEncState = PIND & 0b00110000; // (bit(PIN_HALL1)|bit(PIN_HALL2));
...
extern void motor_init() {
  ...
  PCMSK2 |= 0b00110000;    // turn on pins PD4 & PD5, PCINT20 & PCINT21 (=Arduino pins D4, D5) // (bit(PIN_HALL1)|bit(PIN_HALL2));
